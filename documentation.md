# DictaTranscribe — ТЗ + Project Bible (единый документ) 
 ...
 ## 0) Режим работы (контракт для Trae / IDE) 
 **Роли:** 
 - Trae AI: генерирует/правит код, файлы, команды; объясняет точечно; не “переписывает всё”. 
 - Android Studio: выполняет сборку/запуск, показывает ошибки/логи. 
 ...
 **Правила (анти-сбои):** 
 ...
 6) Этот файл — **источник правды**. Если Trae предлагает отойти — сначала обновить этот документ и согласовать. 
